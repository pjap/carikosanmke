console.log('models KONTRAKAN PETAK');
...
let kontrakanSchema = new Schema({
  ...
  fasilitas: [],
  totalLuas: { type: String, required: true },
...
let kontrakanPetak = mongoose.model('kontrakanPetak', kontrakanSchema)

module.exports = kontrakanPetak;
